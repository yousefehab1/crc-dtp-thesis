...
The license covers the code only. `Data/TCGA-CDR.csv` is the TCGA Clinical
Data Resource of Liu et al. (2018), Cell 173(2):400-416.e11,
doi:10.1016/j.cell.2018.02.052, redistributed here for reproducibility and
subject to its original terms. Results derived from TCGA expression and
clinical data, including the tables under `supplementary_tables/`, remain
subject to the NCI Genomic Data Commons data use policies. The signature panel
is per-sample confidential data and is not distributed with this repository.
